  ...
  chrome.storage.local.get(null, function (result) {
    if (result) {
      ...
      let titles = [],
        time = [],
        barColors = [];
      // get information for each site and total time elapsed
      ...
      //replace time.svg with time if <60 
